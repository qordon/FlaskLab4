...
import random
from db import insert_temperatures, get_temperatures, update_levels, get_limits, clear_database, set_heater_state, get_heater_state
import threading
import time
...
@app.route('/')
def index():
    return render_template('index.html', states=states_lamp, states_temperature = states_temperature, limits=[min_temperature_limit, max_temperature_limit])
...
if __name__ == '__main__':
    ...
    temperature_thread = threading.Thread(target=clock, args=(5,))
